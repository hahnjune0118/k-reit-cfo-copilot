...
This Streamlit MVP is a client-facing AX consulting prototype for Korean listed REIT leadership teams. It is designed to look and feel like a decision intelligence platform, not an internal accounting automation tool.

## Customer Pain Point

Listed REIT CFOs, AMCs, and IR teams need to explain dividend sustainability, refinancing exposure, asset risk, tax impact, and disclosure quality under changing market conditions. In practice, the inputs often live across DART disclosures, IR decks, lender workbooks, valuation files, tax schedules, and manually maintained Excel models.
